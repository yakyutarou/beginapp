class OrderBuy
  ...
  attr_accessor :myouji, :namae, :kana_namae, :kana_myouji, :age, :postal_code, :area, :city, :address, :building_name,
                :phone_number, :user_id, :food_id, :token
  ...
  def save
    ...
    Order.create(myouji: myouji, namae: namae, kana_myouji: kana_myouji, kana_namae: kana_namae, age: age, postal_code: postal_code,
